            ...
            <div className="relative group">
                ...
                <div className="relative">
                    <textarea
                        id={id}
                        className={cn(
                            'flex min-h-[160px] w-full rounded-xl border-2 border-gray-200 bg-white/50 backdrop-blur-sm px-5 py-4 text-base font-medium text-gray-900 placeholder:text-gray-400 placeholder:font-normal',
